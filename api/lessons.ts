...
// --- INTERFACES (Keeps your data structured) ---
// api/lessons.ts
...
const lesson1: Lesson = {
  ...
  vocabulary: [
    ...
    { word: "请", pinyin: "qǐng", english: "please (polite request); to treat/invite" },
    ...
    { word: "李", pinyin: "lǐ", english: "surname Li; plum" },
    { word: "王朋", pinyin: "wáng péng", english: "Wang Peng (male name)" },
    { word: "王", pinyin: "wáng", english: "surname Wang; king" },
    ...
    { word: "也", pinyin: "yě", english: "too; also" },
  ...
  patterns: [
    {
      ...
      patterns: ["你/您好！", "Address someone by title + 先生/小姐/老师"]
    },
    {
      function: "Ask for and provide names",
      patterns: ["你叫什么名字？ — 我叫……。", "你/您贵姓？ — 我姓……。", "请问，+ question?"]
    },
    {
      function: "Confirm someone’s profession or origin",
      patterns: ["我是……，你呢？", "我也是……。", "我不是……。"]
    }
  ],
  grammar: [
    {
      ...
      points: [
        { structure: "Pronoun + 姓 + surname", usage: "Somebody's surname is..." },
        { structure: "Pronoun + 叫 + full name", usage: "Somebody is called..." },
        { structure: "Subject + 是 + occupation/origin", usage: "The subject is..." }
      ]
    },
    {
    ...
    },
    {
      ...
      points: [{ structure: "Subject (S) + Verb (V) + Object (O)" }]
    },
    {
      topic: "Use of 也 (yě)",
      points: [{ structure: "Subject + 也 + Verb + Object", usage: "Subject ... also ..." }]
    }
  ]
};
